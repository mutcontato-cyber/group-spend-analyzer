...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://group-spend-analyzer.lovable.app/" },
      { property: "og:site_name", content: "Gestão Obra" },
      { property: "og:image", content: "https://group-spend-analyzer.lovable.app/og-image.jpg" },
      { property: "og:image:secure_url", content: "https://group-spend-analyzer.lovable.app/og-image.jpg" },
      { property: "og:image:type", content: "image/jpeg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Gestão Obra — dashboard financeiro" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://group-spend-analyzer.lovable.app/og-image.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://group-spend-analyzer.lovable.app/" }],
